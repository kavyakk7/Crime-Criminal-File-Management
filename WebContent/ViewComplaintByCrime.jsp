...
<body><br>
	...
	<div class="container">
	<h2> Crimes in category : <%=crime %> :</h2>
	...
	String QueryString = "Select case_id,comp_name,comp_details,comp_area,comp_status,complaint_date from complaint WHERE comp_name='"+crime+"' and comp_area in "+areas;
