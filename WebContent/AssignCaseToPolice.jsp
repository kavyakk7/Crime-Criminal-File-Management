...
<div class="panel panel-default ">
  ...
  <center><h1>Hello <i><%= c.getPs_name() %></i> Sir,  Welcome!</h1>
		...
		if(dao.PoliceAssign_caseTopolice(ps_name, caseid))
		{
			%>
			...
			String query = "update complaint set assigned_to_police = '"+ps_name+"' where case_id = '"+caseid+"'";
		...
		{
			%>
			Error finding police for assigning case!
			<%
		}
		%>
		</center>
