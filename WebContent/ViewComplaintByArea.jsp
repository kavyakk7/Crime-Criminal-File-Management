...
<body><br>
	...
	String QueryString = "Select case_id,comp_name,comp_details,comp_area, comp_status,complaint_date from complaint WHERE comp_area='"+crime+"'";
